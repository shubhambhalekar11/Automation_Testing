package AutomationPoject1.Project2;
	...
	@Test
	public void plotsAndGeometryPage() throws IOException {
		  
		     WebElement plotsAndGeometry = driver.findElement(By.xpath(p.getProperty("plotsAndGeometry")));
		     
		     plotsAndGeometry.click();
		}
